...
const TransformOverride = ({ transform, children, style, ...other }: any) => {
  console.log(style, children, other)
  return React.cloneElement(children, {
    style: {
      ...children.props.style,
      ...style,
      transform: `${style.transform || ''} rotate(130deg)`
    },
    ...other
  });
}
...
export class Rnd extends React.PureComponent<Props, State> {
  ...
  render() {
    ...
    return (
      ...
      >
          <TransformOverride transform="rotate(30deg)">
            <Resizable
              {...resizableProps}
        ...
        {/* <TransformOverride transform="rotate(70deg)">
         </TransformOverride> */}
        </Draggable>
